...
export default function Debt() {
  ...
  return <div className="erp-page">
    <div className="erp-page-header"><div><h1>Công nợ V1</h1><p>Ledger phải thu/phải trả, aging và phân bổ phiếu thu chi nhiều chứng từ</p></div><div className="flex gap-2"><button className="erp-btn" onClick={() => create("RECEIPT")}><BanknoteArrowDown size={17}/> Lập phiếu thu</button><button className="erp-btn erp-btn-primary" onClick={() => create("VOUCHER")}><BanknoteArrowUp size={17}/> Lập phiếu chi</button></div></div>
